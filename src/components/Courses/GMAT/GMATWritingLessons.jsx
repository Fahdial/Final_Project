...
const GMATWritingLessons = (props) => {
  // menerima data dari getvideodata
console.log("TCL: GMATWritingLessons -> props", props)
  
  console.log(props.match.path);
  // gmat/gmat_writing/:id
  ...
  const renderLesson = () => {
      ...
      let mapLesson = data.map((val,index)=> {
        ...
        return (
          <Fragment>
            <Link to={`/gmat/gmat_writing/${index}`}><li>{val.title}</li></Link>
          </Fragment>
        )
      }
      })
      ...
      return (
        <Fragment>
            <div id ="sidebarr">
              ...
              <div>
                <ul>
                <Link to="/gmat/gmat_writing/" ><button className='searchcolor1'> Back to Syllabus</button> </Link>
                  {/* <li>search</li> */}
                  <div className= "textdetil">
                  <Link to="/gmat/gmat_writing/introduction"><li>Introduction</li></Link>
                  {renderLesson()}
                    </div>
                </ul>
              </div>
            ...
            {/* </div>*/}
              ...
              <div>
              {
                  ...
                  null
                  :
                  <Link to={`/gmat/gmat_writing/${nextLesson(props.match.params.id)}`} ><button className='nextcolor float-right mr-5 mb-3'>NEXT >></button> </Link>
              }
              {
...
export default GMATWritingLessons