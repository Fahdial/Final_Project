...
const TOEFLListeningLessons = (props) => {
  // menerima data dari getvideodata
console.log("TCL: TOEFLListeningLessons -> props", props)
  
  console.log(props.match.path);
  // toefl/toefl_listening/:id
  ...
  const renderLesson = () => {
      ...
      let mapLesson = data.map((val,index)=> {
        ...
        return (
          <Fragment>
            <Link to={`/toefl/toefl_listening/${index}`}><li>{val.title}</li></Link>
          </Fragment>
        )
      }
      })
      ...
      return (
        <Fragment>
            <div id ="sidebarr">
              ...
              <div>
                <ul>
                <Link to="/toefl/toefl_listening/" ><button className='searchcolor1'> Back to Syllabus</button> </Link>
                  {/* <li>search</li> */}
                  <div className= "textdetil">
                  <Link to="/toefl/toefl_listening/introduction"><li>Introduction</li></Link>
                  {renderLesson()}
                    </div>
                </ul>
              </div>
            ...
            {/* </div>*/}
              ...
              <div>
              {
                  ...
                  null
                  :
                  <Link to={`/toefl/toefl_listening/${nextLesson(props.match.params.id)}`} ><button className='nextcolor float-right mr-5 mb-3'>NEXT >></button> </Link>
              }
              {
...
export default TOEFLListeningLessons