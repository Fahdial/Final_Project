...
const IELTSSpeakingLessons = (props) => {
  // menerima data dari getvideodata
console.log("TCL: IELTSSpeakingLessons -> props", props)
  
  console.log(props.match.path);
  // ielts/ielts_speaking/:id
  ...
  const renderLesson = () => {
      ...
      let mapLesson = data.map((val,index)=> {
        ...
        return (
          <Fragment>
            <Link to={`/ielts/ielts_speaking/${index}`}><li>{val.title}</li></Link>
          </Fragment>
        )
      }
      })
      ...
      return (
        <Fragment>
            <div id ="sidebarr">
              ...
              <div>
                <ul>
                <Link to="/ielts/ielts_speaking/" ><button className='searchcolor1'> Back to Syllabus</button> </Link>
                  {/* <li>search</li> */}
                  <div className= "textdetil">
                  <Link to="/ielts/ielts_speaking/introduction"><li>Introduction</li></Link>
                  {renderLesson()}
                    </div>
                </ul>
              </div>
            ...
            {/* </div>*/}
              ...
              <div>
              {
                  ...
                  null
                  :
                  <Link to={`/ielts/ielts_speaking/${nextLesson(props.match.params.id)}`} ><button className='nextcolor float-right mr-5 mb-3'>NEXT >></button> </Link>
              }
              {
...
export default IELTSSpeakingLessons