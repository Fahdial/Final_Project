                ...
                <div className="judul">
                    <div>
                        <h1 className="col-8 offset-2">
                            Pilih salah satu dari 4 kebutuhan dalam meraih nilai terbaik IELTS anda
                        </h1>
                    </div>
                    <br/>
                    <br/>
                            ...
                            <table className="judull table p-5 ">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <Link className="masukkls" to="/ielts/ielts_writing">Enter Writing Task ></Link>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <Link className="masukkls" to="/ielts/ielts_reading">Enter Reading Task ></Link>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <Link className="masukkls" to="/ielts/ielts_speaking">Enter Speaking Task ></Link>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <Link className="masukkls" to="/ielts/ielts_listening">Enter Listening  Task ></Link>
                                    </td>
                                </tr>
                            </table>
                            <button 
