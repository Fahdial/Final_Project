...
const IELTSListeningLessons = (props) => {
  // menerima data dari getvideodata
console.log("TCL: IELTSlisteningLessons -> props", props)
  
  console.log(props.match.path);
  // ielts/ielts_listening/:id
  ...
  const renderLesson = () => {
      ...
      let mapLesson = data.map((val,index)=> {
        ...
        return (
          <Fragment>
            <Link to={`/ielts/ielts_listening/${index}`}><li>{val.title}</li></Link>
          </Fragment>
        )
      }
      })
      ...
      return (
        <Fragment>
            <div id ="sidebarr">
              ...
              <div>
                <ul>
                <Link to="/ielts/ielts_listening/" ><button className='searchcolor1'> Back to Syllabus</button> </Link>
                  {/* <li>search</li> */}
                  <div className= "textdetil">
                  <Link to="/ielts/ielts_listening/introduction"><li>Introduction</li></Link>
                  {renderLesson()}
                    </div>
                </ul>
              </div>
            ...
            {/* </div>*/}
              ...
              <div>
              {
                  ...
                  null
                  :
                  <Link to={`/ielts/ielts_listening/${nextLesson(props.match.params.id)}`} ><button className='nextcolor float-right mr-5 mb-3'>NEXT >></button> </Link>
              }
              {
...
export default IELTSListeningLessons